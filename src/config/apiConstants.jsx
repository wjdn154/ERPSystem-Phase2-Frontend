...
export const COMMON_API = {
    ...
    CREATE_NOTIFICATION_API: (employeeId, tenantId, module, permission) => `${API_BASE_URL}/api/notifications/create-notification?employeeId=${employeeId}&tenantId=${tenantId}&module=${module}&permission=${permission}`, // 알림 생성 및 조회 API
};
