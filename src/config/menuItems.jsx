...
import WarehouseRegistrationPage from "../modules/logistics/pages/WarehouseRegistrationPage.jsx";
    ...
    '물류관리': [
        {
            ...
            items: [
                ...
                { text: '창고등록', component: WarehouseRegistrationPage, apiPath: LOGISTICS_API.WAREHOUSE_LIST_API },
            ]
        },
        {
            text: '영업 관리',
