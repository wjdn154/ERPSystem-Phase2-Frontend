            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={12}>
                    <WelcomeSection
                        ...
                        description={(
                            <Typography>
                                재무상태표 페이지는 <span>기업의 자산, 부채, 자본 등 재무 상태</span>를 한눈에 파악할 수 있는 기능을 제공함. <span>재무상태표</span>는 기업의 <span>재무 건전성</span>을 평가하는 중요한 자료로, 사용자는 <span>자산과 부채의 균형</span>을 통해 기업의 재무 건전성을 쉽게 확인할 수 있음.
                            </Typography>
                        )}
                        tabItems={tabItems()}
