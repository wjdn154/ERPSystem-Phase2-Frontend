            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={12}>
                    <WelcomeSection
                        ...
                        description={(
                            <Typography>
                                전표 출력 페이지는 <span>입력된 전표를 출력</span>할 수 있는 기능을 제공함. 사용자는 재무 보고서나 기타 문서 작성을 위해 <span>전표를 인쇄</span>하거나 PDF로 저장 가능함. 이를 통해 재무 데이터를 <span>효율적으로 기록 및 보관</span>할 수 있음.
                            </Typography>
                        )}
                        tabItems={tabItems()}
