            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={12}>
                    <WelcomeSection
                        ...
                        description={(
                            <Typography>
                                급여 정산 페이지는 <span>사원의 공제항목과 수당항목</span>을 기반으로 매월 급여를 계산하는 기능을 제공함. 이 페이지에서는 <span>사원의 공제항목과 수당항목</span> 을
                                입력하여 <span>정확한 급여 계산</span>을 진행할 수 있으며, 자동으로 각종 <span>세금과 보험료</span>가 반영된 금액을 확인할 수 있음.
                                이를 통해 사원의 급여 내역 효율적으로 관리하고, 자동으로 각종 세금과 보험료를 반영할 수 있음.
                            </Typography>
                        )}
                        tabItems={tabItems()}
