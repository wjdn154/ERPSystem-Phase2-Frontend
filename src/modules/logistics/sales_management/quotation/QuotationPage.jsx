            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={12}>
                    <WelcomeSection
                        ...
                        description={(
                            <Typography>
                                견적서 페이지는 <span>고객에게 제품이나 서비스를 제공하기 전 예상 비용</span>을 산출하고, 이를 문서화하는 곳임. 이 페이지에서는 <span>견적서를 작성, 수정, 삭제</span>할 수 있으며, <span>견적서 항목</span>을 추가하고 <span>수량, 단가, 총 비용</span>을 자동으로 계산하는 기능이 포함됨.
                            </Typography>
                        )}
                        tabItems={tabItems()}
