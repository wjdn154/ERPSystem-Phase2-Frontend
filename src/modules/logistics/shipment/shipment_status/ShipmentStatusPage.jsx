...
const ShipmentStatusPage = () => {
    ...
    const [shipmentProductsData, setShipmentProductsData] = useState([]);
    ...
    const fetchShipmentProducts = async (startDate, endDate) => {
        setIsLoading(true);
        try {
            ...
            notify('error', '출하현황 조회 실패', '출하현황 조회 중 문제가 발생했습니다.', 'top');
        } finally {
            setIsLoading(false);
        }
    }
                                ...
                                <Grid sx={{margin: '20px'}}>
                                    <Table
                                        ...
                                        columns={[
                                            ...
                                            {
                                                title: <div className="title-text">고객명</div>,
                                            ...
                                            {
                                                title: <div className="title-text">연락처</div>,
