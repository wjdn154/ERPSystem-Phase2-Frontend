export const productDetailColumn = [
    ...
    {
        title: <span>단위</span>,  // 컬럼 제목
        dataIndex: 'unit',  // 데이터 인덱스: 이 필드는 데이터 객체의 'parentCode' 속성과 연결됩니다.
        width: '5%',  // 컬럼 너비 설정
    },
    {
    ...
    {
        title: <span>생상 라우팅</span>,  // 컬럼 제목
        dataIndex: 'productionRoutingName',  // 데이터 인덱스: 이 필드는 데이터 객체의 'parentCode' 속성과 연결됩니다.
        width: '10%',  // 컬럼 너비 설정
    },
];