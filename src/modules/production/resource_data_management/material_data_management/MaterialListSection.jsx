        ...
        <Paper elevation={3} sx={{height: '100%', p: 2}}>
            ...
            >
                ...
                <div style={{display: 'flex', alignItems: 'center'}}>
                    ...
                    <Input value={"유해물질 개수"}
                           style={{marginRight: '10px', marginTop: '20px', flex: 1, backgroundColor: '#f6a6a6'}}
                           readOnly/>
                    <Input value={materialDataDetail?.hazardousMaterialQuantity || ''}
                           style={{marginTop: '20px', flex: 1}}
                           onChange={(e) => handleInputChange(e, 'hazardousMaterialQuantity')}/>
                </div>
            </Modal>
            ...
            <div style={{display: 'flex', justifyContent: 'flex-end', marginRight: '20px'}}>
                <Button onClick={updateModal} type="primary"
                        ...
                        disabled={!materialDataDetail || materialDataDetail.id}> 수정</Button>
                <Button onClick={handleDelete} type="danger"
                        disabled={!materialDataDetail || materialDataDetail.id}>삭제</Button>
            </div>
        </Paper>
    )
}
