...
export const fetchWorkerList = async () => {
    try {
        const response = await axios.post(PRODUCTION_API.WORKER_LIST_API);
...
export const fetchWorkerDetail = async (id) => {
    try {
        const response = await axios.post(PRODUCTION_API.WORKER_DETAIL_API(id));
...
export const fetchWorkerAttendanceAssignmentList = async (id) => {
    try {
        const response = await axios.post(PRODUCTION_API.WORKER_ATTENDANCE_ASSIGNMENT_LIST_API(id));
        return response.data;
    }catch (error){
